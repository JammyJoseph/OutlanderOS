...
const HUBS = [
  ...
  { name: 'Direct', location: 'Direct from printer', isDirect: true, serves: 'Asia-Pacific and Australia stockist cartons shipped direct from the print floor — the longest lane, book it first.' },
]
...
const CHANNELS = [
  ...
  { name: 'Global stockists (B2B)', units: 3750, kind: 'B2B', hub: 'UK', purpose: '3,000 primary selects across 53 trading outlets, one delivery each. 750 held for secondary selects and replenishment.' },
...
const STOCKISTS: S[] = [
  { n: 'Selfridges', city: 'London', market: 'UK', hub: 'UK', profile: 'Talent-led', tier: 'WIDER', units: 80 },
  { n: 'Good News', city: 'London', market: 'UK', hub: 'UK', profile: 'Even', tier: 'PRIMARY', units: 80 },
  { n: 'Shreeji News', city: 'London', market: 'UK', hub: 'UK', profile: 'Even', tier: 'WIDER', units: 80 },
  { n: 'Dover St Market (via Idea Books)', city: 'London', market: 'UK', hub: 'UK', profile: 'Talent-led', tier: 'WIDER', units: 80 },
  { n: 'News & Coffee, Coal Drops Yard', city: 'London', market: 'UK', hub: 'UK', profile: 'Even', tier: 'WIDER', units: 50 },
  { n: 'MagCulture', city: 'London', market: 'UK', hub: 'UK', profile: 'Talent-led', tier: 'PRIMARY', units: 80 },
  { n: 'Serpentine Gallery', city: 'London', market: 'UK', hub: 'UK', profile: 'Talent-led', tier: 'WIDER', units: 50 },
  { n: 'UAL: Central St Martins (Archway)', city: 'London', market: 'UK', hub: 'UK', profile: 'Even', tier: 'WIDER', units: 20 },
  { n: 'Selfridges', city: 'Manchester', market: 'UK', hub: 'UK', profile: 'Talent-led', tier: 'WIDER', units: 50 },
  { n: 'Soho News International', city: 'New York', market: 'US', hub: 'US (SLC)', profile: 'Even', tier: 'PRIMARY', units: 250 },
  { n: 'Casa Magazines', city: 'New York', market: 'US', hub: 'US (SLC)', profile: 'Even', tier: 'WIDER', units: 80 },
  { n: 'Mulberry Iconic', city: 'New York', market: 'US', hub: 'US (SLC)', profile: 'Even', tier: 'WIDER', units: 80 },
  { n: 'Iconic Magazines', city: 'New York', market: 'US', hub: 'US (SLC)', profile: 'Even', tier: 'WIDER', units: 80 },
  { n: 'Dashwood Books', city: 'New York', market: 'US', hub: 'US (SLC)', profile: 'Talent-led', tier: 'WIDER', units: 50 },
  { n: 'Printed Matter', city: 'Chelsea, New York', market: 'US', hub: 'US (SLC)', profile: 'Talent-led', tier: 'WIDER', units: 50 },
  { n: 'McNally Jackson', city: 'Soho, New York', market: 'US', hub: 'US (SLC)', profile: 'Talent-led', tier: 'WIDER', units: 50 },
  { n: 'Kid Super Workshop', city: 'New York', market: 'US', hub: 'US (SLC)', profile: 'Character-led', tier: 'WIDER', units: 50 },
  { n: 'Atlanta allocation', city: 'Atlanta', market: 'US', hub: 'US (SLC)', profile: 'Even', tier: 'WIDER', units: 50 },
  { n: 'Miami allocation', city: 'Miami', market: 'US', hub: 'US (SLC)', profile: 'Even', tier: 'WIDER', units: 50 },
  { n: 'Chicago allocation', city: 'Chicago', market: 'US', hub: 'US (SLC)', profile: 'Even', tier: 'WIDER', units: 50 },
  { n: 'Reserved — home city of Cover 1', city: 'TBC', market: 'US', hub: 'US (SLC)', profile: 'Even', tier: 'WIDER', units: 0, reserved: true },
  { n: 'Reserved — home city of Cover 2', city: 'TBC', market: 'US', hub: 'US (SLC)', profile: 'Even', tier: 'WIDER', units: 0, reserved: true },
  { n: 'San Francisco allocation', city: 'San Francisco', market: 'US', hub: 'US (SLC)', profile: 'Even', tier: 'PRIMARY', units: 50 },
  { n: 'Chess Club', city: 'Portland', market: 'US', hub: 'US (SLC)', profile: 'Even', tier: 'PRIMARY', units: 50 },
  { n: 'Brazos Bookstore', city: 'Houston', market: 'US', hub: 'US (SLC)', profile: 'Talent-led', tier: 'PRIMARY', units: 50 },
  { n: 'Beverly Hills Newsstand', city: 'Beverly Hills', market: 'US', hub: 'US (SLC)', profile: 'Even', tier: 'PRIMARY', units: 50 },
  { n: 'Dover Street Market LA', city: 'Los Angeles', market: 'US', hub: 'US (SLC)', profile: 'Talent-led', tier: 'WIDER', units: 50 },
  { n: 'Book Soup', city: 'West Hollywood', market: 'US', hub: 'US (SLC)', profile: 'Talent-led', tier: 'WIDER', units: 50 },
  { n: 'Pablo T-Shirt Factory', city: 'Paris', market: 'France', hub: 'EU (NL)', profile: 'Character-led', tier: 'WIDER', units: 50 },
  { n: 'Shakespeare and Company', city: 'Paris', market: 'France', hub: 'EU (NL)', profile: 'Talent-led', tier: 'WIDER', units: 80 },
  { n: 'Reading Room', city: 'Milan', market: 'Italy', hub: 'EU (NL)', profile: 'Talent-led', tier: 'WIDER', units: 80 },
  { n: 'AirMail', city: 'Milan', market: 'Italy', hub: 'EU (NL)', profile: 'Even', tier: 'WIDER', units: 50 },
  { n: 'Gucci Garden', city: 'Florence', market: 'Italy', hub: 'EU (NL)', profile: 'Talent-led', tier: 'WIDER', units: 50 },
  { n: 'Edicola Erno', city: 'Rome', market: 'Italy', hub: 'EU (NL)', profile: 'Even', tier: 'WIDER', units: 50 },
  { n: 'News and Coffee', city: 'Barcelona', market: 'Spain', hub: 'EU (NL)', profile: 'Even', tier: 'WIDER', units: 50 },
  { n: 'Odd Kiosk', city: 'Barcelona', market: 'Spain', hub: 'EU (NL)', profile: 'Even', tier: 'WIDER', units: 50 },
  { n: 'SGEL', city: 'Madrid', market: 'Spain', hub: 'EU (NL)', profile: 'Even', tier: 'WIDER', units: 50 },
  { n: 'do you read me?!', city: 'Berlin', market: 'Germany', hub: 'EU (NL)', profile: 'Even', tier: 'PRIMARY', units: 100 },
  { n: 'Gudberg Nerger', city: 'Hamburg', market: 'Germany', hub: 'EU (NL)', profile: 'Even', tier: 'WIDER', units: 80 },
  { n: 'Issues', city: 'Toronto', market: 'Canada', hub: 'US (SLC)', profile: 'Even', tier: 'PRIMARY', units: 60 },
  { n: 'Presse Internationale', city: 'Toronto', market: 'Canada', hub: 'US (SLC)', profile: 'Even', tier: 'WIDER', units: 40 },
  { n: 'IMS Belgium', city: 'Antwerp', market: 'Belgium', hub: 'EU (NL)', profile: 'Even', tier: 'WIDER', units: 50 },
  { n: 'NIPPAN IPS Co. Ltd.', city: 'Tokyo, Japan', market: 'Rest of world', hub: 'Direct', profile: 'Character-led', tier: 'PRIMARY', units: 50 },
  { n: 'Stone and Wave Co. Ltd.', city: 'Seoul, South Korea', market: 'Rest of world', hub: 'Direct', profile: 'Character-led', tier: 'PRIMARY', units: 50 },
  { n: 'World Magazine Co. Ltd.', city: 'Seoul, South Korea', market: 'Rest of world', hub: 'Direct', profile: 'Character-led', tier: 'WIDER', units: 50 },
  { n: 'Basheer Graphic Books', city: 'Singapore', market: 'Rest of world', hub: 'Direct', profile: 'Character-led', tier: 'WIDER', units: 30 },
  { n: 'Reading Books', city: 'Carlton, Australia', market: 'Rest of world', hub: 'Direct', profile: 'Character-led', tier: 'WIDER', units: 30 },
  { n: 'Athenaeum', city: 'Amsterdam', market: 'Rest of world', hub: 'EU (NL)', profile: 'Even', tier: 'PRIMARY', units: 30 },
  { n: 'Papercut', city: 'Stockholm', market: 'Rest of world', hub: 'EU (NL)', profile: 'Character-led', tier: 'WIDER', units: 30 },
  { n: 'Hyper Hypo E.E', city: 'Athens', market: 'Rest of world', hub: 'EU (NL)', profile: 'Character-led', tier: 'WIDER', units: 30 },
  { n: 'The Monocle Kiosk', city: 'Zurich', market: 'Rest of world', hub: 'EU (NL)', profile: 'Talent-led', tier: 'WIDER', units: 30 },
  { n: 'The Library Project', city: 'Dublin', market: 'Rest of world', hub: 'EU (NL)', profile: 'Talent-led', tier: 'WIDER', units: 30 },
  { n: 'Under the Cover', city: 'Lisbon', market: 'Rest of world', hub: 'EU (NL)', profile: 'Talent-led', tier: 'WIDER', units: 30 },
  { n: 'Candy Kiosken', city: 'Frederiksberg', market: 'Rest of world', hub: 'EU (NL)', profile: 'Even', tier: 'WIDER', units: 30 },
  { n: 'Brot Books Deli s.r.o.', city: 'Prague', market: 'Rest of world', hub: 'EU (NL)', profile: 'Even', tier: 'WIDER', units: 30 },
]
...
const MILESTONES = [
  ...
  ['By 25 September', '2026-09-25', 'Book UK, US and EU freight plus the direct air freight to Tokyo and Seoul; complete customs documents; confirm importer details and warehouse booking slots; all packaging inbound.', 'Ops / Freight'],
  ...
  ['W/C 5 October', '2026-10-05', 'Collect stock from printer; dispatch UK, US and EU allocations; dispatch event stock and the direct printer cartons for Tokyo and Seoul; monitor inbound freight daily.', 'Ops / Freight'],
  ...
  ['19–22 October', '2026-10-19', 'Pick and pack the promo wave: 12 accounts, whole allocation each, all four covers in one carton set, embargo notice packed on top of every carton.', 'Warehouses'],
  ...
  ['Friday 23 October', '2026-10-23', 'PROMO WAVE DISPATCHED — 12 accounts, one shipment each, full allocation, all four covers. This is the only stockist stock in the world before Drop 1.', 'Warehouses'],
  ...
  ['Monday 9 November', '2026-11-09', 'Pick and pack the wider wave: 41 accounts, whole allocation each, one carton set per store. Reconcile against the promo wave and the reserve before release.', 'Warehouses'],
  ['Thursday 12 November', '2026-11-12', 'WIDER WAVE DISPATCHED — 41 accounts, one shipment each. Lands after Drop 3, so there is no embargo to police and nothing to leak.', 'Warehouses'],
...
async function verify(planId: string) {
  ...
  for (const h of hubTotals(input)) {
    console.log(`  ${h.hub.name.padEnd(10)} B2C ${String(h.b2cAndGifting).padStart(5)}  events ${String(h.events).padStart(4)}  stockists ${String(h.stockists).padStart(5)}  reserve ${String(h.reserveAndBuffer).padStart(5)}  = ${String(h.total).padStart(6)} (${h.sharePct.toFixed(1)}%)`)
  }
