        ...
        <div className="mb-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
          {kpis.map((kpi) => {
            ...
            return (
              <div
                key={kpi.label}
                className="card-apple rounded-xl p-5 transition-all duration-200"
              >
          ...
          {portals.map((portal) => {
            ...
            return (
              <Link
                key={portal.href}
                href={portal.href}
                className="card-apple group relative flex flex-col rounded-xl p-5 transition-all duration-200 hover:shadow-md hover:shadow-amber-100/50 hover:border-[#D4A853]/30"
              >
                ...
                <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-gray-100 transition-colors group-hover:bg-amber-50">
                ...
                <p className="mt-1 text-xs leading-snug text-gray-500">{portal.description}</p>
                {portal.stat && (
                  <p className="mt-3 text-xs font-medium text-[#D4A853]">{portal.stat}</p>
                )}
              </Link>
            );
          })}
