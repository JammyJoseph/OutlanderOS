      ...
      {valid.map((doc, i) => {
        const inner = (
          <>
            ...
            <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-[#A93B2E]/10 text-[#A93B2E] flex-shrink-0">
        ...
        return doc.url ? (
          <a
            ...
            className="flex items-center gap-2.5 rounded-xl border border-gray-100 dark:border-gray-800 px-3 py-2 hover:border-[#A93B2E]/50 hover:bg-[#A93B2E]/5 transition-colors"
          >
            {inner}
          </a>
        ) : (
