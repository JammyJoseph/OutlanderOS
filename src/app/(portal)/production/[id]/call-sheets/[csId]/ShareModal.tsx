    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-gray-100">
          <h3 className="text-sm font-bold text-gray-800">Share Call Sheet</h3>
        ...
        {/* Mode switch */}
        <div className="flex gap-1 bg-gray-100 rounded-xl p-1 m-5 mb-3">
        ...
        <div className="px-5 pb-5">
          ...
          {!token ? (
            <p className="text-sm text-amber-600 bg-amber-50 border border-amber-100 rounded-xl px-3.5 py-2.5">
            ...
            <>
              ...
              <div className="flex gap-2">
                <input
                  readOnly
                  value={url}
                  className="flex-1 px-3 py-2 rounded-xl border border-gray-200 text-xs text-gray-600 bg-gray-50 truncate"
                />
                <button
                  onClick={copy}
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#ff4444]/25 focus:border-[#ff4444]"
                />
                <button
                  onClick={sendEmail}
                  disabled={!emails.trim()}
                  className="flex items-center gap-1.5 border border-gray-200 text-gray-700 px-3.5 py-2 rounded-xl text-sm font-medium shrink-0 disabled:opacity-40 hover:bg-gray-50"
                >
                  <Send size={14} /> Send
                </button>
              </div>
