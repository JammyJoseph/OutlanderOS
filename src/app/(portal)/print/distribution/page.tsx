  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-6 py-3">
        ...
        <button className="flex items-center gap-1.5 rounded-lg bg-[#111111] dark:bg-white px-3 py-2 text-xs font-semibold text-white dark:text-black hover:opacity-90">
      ...
      <div className="flex-1 overflow-auto p-6 space-y-6">
        ...
        {records.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <button className="mt-4 flex items-center gap-1.5 rounded-lg bg-[#111111] dark:bg-white px-4 py-2 text-xs font-semibold text-white dark:text-black hover:opacity-90">
              <Plus className="h-3.5 w-3.5" />
              Add Distribution
            </button>
          </div>
