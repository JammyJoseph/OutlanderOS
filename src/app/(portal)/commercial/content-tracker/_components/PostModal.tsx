          ...
          <div className="sticky bottom-0 flex items-center justify-between gap-3 border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 px-5 py-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={save}
                disabled={saving}
                className="rounded-lg bg-[#111111] px-4 py-1.5 text-sm font-medium text-white dark:bg-white dark:text-black shadow-sm hover:bg-[#111111] dark:hover:bg-white disabled:opacity-60"
              >
                {saving ? "Saving…" : "Save"}
              </button>
            </div>
