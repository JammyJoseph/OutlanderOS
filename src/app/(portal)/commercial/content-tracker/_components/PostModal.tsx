...
export default function PostModal({ post, campaigns, onClose, onSave }: Props) {
  ...
  return (
    ...
    >
      <div
        className="my-8 grid w-full max-w-5xl grid-cols-1 overflow-hidden rounded-2xl bg-white shadow-2xl md:grid-cols-2"
          ...
          <div className="space-y-4 p-5">
              ...
              <div className="flex flex-wrap gap-1.5">
                ...
                <div className="flex items-center gap-1">
                  <input
                    ...
                    className="rounded-full border border-gray-200 bg-white px-3 py-1 text-xs outline-none focus:border-amber-400"
                  />
                  <button
                    onClick={addBrand}
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full resize-none rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm outline-none focus:border-amber-400"
                placeholder="Internal notes…"
              />
            </div>
          </div>

          <div className="sticky bottom-0 flex items-center justify-between gap-3 border-t border-gray-100 bg-white px-5 py-3">
            {post.permalink ? (
              <a
                href={post.permalink}
                target="_blank"
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={save}
                disabled={saving}
                className="rounded-lg bg-[#D4A853] px-4 py-1.5 text-sm font-medium text-white shadow-sm hover:bg-[#c29846] disabled:opacity-60"
              >
                {saving ? "Saving…" : "Save"}
              </button>
            </div>
