          ...
          <div className="space-y-5 p-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                disabled={reporting}
                className="inline-flex items-center gap-1 rounded-lg bg-[#D4A853] px-3 py-1.5 text-xs font-medium text-white shadow-sm hover:bg-[#c29846] disabled:opacity-60"
              >
    ...
    <div className="flex h-32 items-end gap-2 rounded-lg border border-gray-100 bg-gray-50 p-3">
      {timeline.map((t) => (
        <div key={t.month} className="flex flex-1 flex-col items-center gap-1">
          ...
          <div
            className="w-full rounded-t bg-[#D4A853]/80"
