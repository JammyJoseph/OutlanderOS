      ...
      <div className="mx-auto max-w-5xl px-6 py-8">
        ...
        <div className="relative mb-4 max-w-sm">
          ...
          <input
            ...
            className="w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 py-2 pl-8 pr-3 text-sm focus:border-[#9C7C2E] dark:focus:border-[#C9A44A] focus:outline-none focus:ring-2 focus:ring-[#9C7C2E]/30 dark:focus:ring-[#C9A44A]/30"
          />
        </div>
