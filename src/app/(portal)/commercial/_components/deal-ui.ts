...
export const STAGE_GROUPS: {
  ...
  },
  {
    ...
    accent: "text-[#9C7424] dark:text-[#C9A44A]",
    dot: "bg-[#9C7C2E] dark:bg-[#C9A44A]",
  },
  {
    key: "active",
    label: "Active",
...
> = {
  ...
  IO_SIGNED: { label: "IO Signed & Kick Off", bg: "bg-yellow-100", text: "text-yellow-700", dot: "bg-[#9C7C2E] dark:bg-[#C9A44A]", bar: "bg-[#9C7C2E] dark:bg-[#C9A44A]" },
  ...
  BUDGET_SET: { label: "IO Signed & Kick Off", bg: "bg-yellow-100", text: "text-yellow-700", dot: "bg-[#9C7C2E] dark:bg-[#C9A44A]", bar: "bg-[#9C7C2E] dark:bg-[#C9A44A]" },
};
